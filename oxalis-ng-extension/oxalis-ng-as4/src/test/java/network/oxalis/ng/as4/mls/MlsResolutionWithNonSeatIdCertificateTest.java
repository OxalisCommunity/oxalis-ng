...
public class MlsResolutionWithNonSeatIdCertificateTest extends AbstractJettyServerTest {
    ...
    @Test
    public void mlsToAbsentIsLeftAbsentWhenCertificateIsNotASeatId() throws Exception {
        Header enriched = sendResource("/mls/bis3-invoice-mls-both-absent.xml");

        Assert.assertNull(enriched.getMlsToIdentifier());
        Assert.assertEquals(enriched.getMlsTypeIdentifier(), MlsTypeIdentifier.of("FAILURE_ONLY"));
    }

    @Test
    public void mlsToPresentIsStillIgnoredWhenCertificateIsNotASeatId() throws Exception {
