...
/**
 * Provides access to selected Maven injected properties in the oxalis-ng-version.properties file.
 *
 * @author steinar
 * @author thore
 * @author erlend
...
public class OxalisVersion {
    ...
    static {
        try (InputStream inputStream = OxalisVersion.class.getResourceAsStream("/oxalis-ng-version.properties")) {
    ...
    public static String getVersion() {
        return properties.getProperty("oxalis.ng.version");
    }
    ...
    public static String getUser() {
        return properties.getProperty("oxalis.ng.user");
    }
