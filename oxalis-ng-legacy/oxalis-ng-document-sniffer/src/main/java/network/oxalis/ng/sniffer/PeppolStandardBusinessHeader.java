...
public class PeppolStandardBusinessHeader {
    ...
    /**
     * An informative unique ID created by the issuer of the envelope. The InstanceIdentifier MUST be unique for each
     * Business Message Envelope being created. This ID is not the same as the ID of the business message (such as the Invoice Number).
     * It is not the same as a transmission Message ID generated by the application sending the message (as defined in AS4).
     * generated by the application sending the message.
     * The InstanceIdentifier MUST be globally unique and it is RECOMMENDED to use UUID (such as 118e3040-51d2-11e3-8f96-0800200c9a66)
