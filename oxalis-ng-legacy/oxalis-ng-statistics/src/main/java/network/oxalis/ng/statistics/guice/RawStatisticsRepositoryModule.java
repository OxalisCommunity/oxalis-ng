...
package network.oxalis.ng.statistics.guice;
...
import network.oxalis.ng.persistence.guice.AopJdbcTxManagerModule;
import network.oxalis.ng.persistence.platform.*;
import network.oxalis.ng.statistics.jdbc.RawStatisticsRepositoryHSqlImpl;
import network.oxalis.ng.statistics.jdbc.RawStatisticsRepositoryMySqlImpl;
import network.oxalis.ng.statistics.api.RawStatisticsRepository;
import network.oxalis.ng.statistics.jdbc.RawStatisticsRepositoryMsSqlImpl;
import network.oxalis.ng.statistics.jdbc.RawStatisticsRepositoryOracleImpl;
