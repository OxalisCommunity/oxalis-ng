...
package network.oxalis.ng.persistence.testng;
...
import network.oxalis.ng.commons.filesystem.FileSystemModule;
import network.oxalis.ng.commons.guice.OxalisModule;
import network.oxalis.ng.persistence.guice.AopJdbcTxManagerModule;
import network.oxalis.ng.persistence.guice.DataSourceModule;
import network.oxalis.ng.test.config.TestConfigModule;
import network.oxalis.ng.test.filesystem.TestFileSystemModule;
